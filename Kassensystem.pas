...
type
  ...
  TKasse = class
    ...
    public
      ...
      property KleingeldParameter: TKleingeldParameter read FKleingeldParameter write FKleingeldParameter;
  ...
  TKassenSystem = class
    ...
    public
      ...
      property WarteschlangenListe: TList<TWarteschlange> read FWarteschlangenListe write FWarteschlangenListe;
  ...
  begin
    try
      ...
      begin
        ...
        until ((Random(30) = 30) or (self.IndexScanvorgang = self.AktuellerKunde.Warenkorb.ArtikelListe.Count - 1));
      end
      else
      begin
...
constructor TKassenSystem.create(Parameter: TKassenParameter; KleingeldParameter: TKleingeldParameter);
var
  i: integer;
begin
...
begin
  ...
  begin
    if (self.WarteschlangenListe[i].IstGeoeffnet) or (self.WarteschlangenListe[i].KundenListe.Count > 0) then
